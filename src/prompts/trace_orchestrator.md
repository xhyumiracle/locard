...
- **Reflection**: When dst tx is fetched, track via `reflection_update = {"step_1": {"task_issued": True}}`
...
- **Reflection**: Track via `reflection_update = {"step_2": {"dst_tx_received": True, "tool_called": True, "task_issued": True}}`
...
- **Reflection**: Track via `reflection_update = {"step_3": {"price_received": True, "tool_called": True, "reused_step2_window": True, "task_issued": True}}`
...
- **Reflection**: Track via `reflection_update = {"step_4": {"search_received": True, "tool_called": True, "task_issued": True}}`
...
- **Reflection**: Track via `reflection_update = {"step_5": {"price_received": True}}`
